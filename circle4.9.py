...
WHITE_TRACK_THRESHOLD = [(42, 80, -26, 3, -55, 18)]
RED_TRACK_THRESHOLD = [(30, 90, 30, 80, -40, 20)]
...
# 起点矩形检测参数
RECTANGLE_ROI = (50, 10, 220, 50)  # 起点矩形出现的区域（x,y,w,h），需要根据实际调整
RECTANGLE_MIN_AREA = 3000  # 矩形最小面积（像素），大于普通轨道（需要调）
RECTANGLE_MAX_AREA = 10000  # 矩形最大面积（像素）（需要调）
RECTANGLE_ASPECT_RATIO = (0.8, 1.2)  # 矩形宽高比范围（接近1，允许轻微偏差）
